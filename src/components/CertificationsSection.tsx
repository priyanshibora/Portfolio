      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid md:grid-cols-3 gap-6 max-w-5xl">
          {certifications.map((cert, index) => (
            <AnimatedSection key={cert.title} delay={0.1 * (index + 1)}>
              <div className="bg-card border border-border rounded-lg p-6 flex flex-col items-center text-center hover:border-primary/50 transition-colors h-full">
